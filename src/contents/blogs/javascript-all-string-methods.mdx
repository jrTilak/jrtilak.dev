...
<Alert>
  ...
  <AlertDescription>
    This guide covers only the active string methods currently supported in
    JavaScript. Deprecated methods are not included to ensure that you have the
    most relevant and up-to-date information for your development needs.
  </AlertDescription>
</Alert>
...
- **What it does**: Returns a new string that contains the characters from the original string, starting at the `startIndex` and extending to _(but not including)_ `endIndex`.
