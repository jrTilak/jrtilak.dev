...
<Alert>
  ...
  <AlertDescription>
    This guide covers only the active string methods currently supported in JavaScript. Deprecated
    methods are not included to ensure that you have the most relevant and up-to-date information
